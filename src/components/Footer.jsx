        ...
        <div className="footer-block">
          ...
          <div className="footer-feedback">
            ...
            <p className="footer-feedback-description list-description">
              ...
              розігрійте сковорідку, додайте кілька яєць,  борошна з молоком,
              перемішайте і смакуйте!
            </p>
          ...
          <div className="footer-menu">
            <h3 className="footer-menu-title first-title">Корисні посилання</h3>
            ...
            <div className="footer-menu-block">
              <ul className="footer-menu-list">
                ...
                <li className="footer-menu-item">
                  <a className="footer-menu-link">База знань</a>
                </li>
                <li className="footer-menu-item">
              ...
              <ul className="footer-menu-list">
                <li className="footer-menu-item">
                  <a className="footer-menu-link">Правила та умови </a>
                </li>
                <li className="footer-menu-item">
                  <a className="footer-menu-link">Політика конфіденційності</a>
                </li>
                <li className="footer-menu-item">
            ...
            <div className="footer-menu-lang">
              ...
              <div className="footer-menu-lang-buttons">
                <button className="footer-menu-lang-button current">Ua</button>
